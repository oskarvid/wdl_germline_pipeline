# The current official beta version of GATK4 has a bug in VariantRecalibrator that has been fixed in the github release, you need to manually change the gatk jar file until they release an official beta version that is easily downloadable with wget in docker.
